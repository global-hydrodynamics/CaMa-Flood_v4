...
#####################################
## for each cycle, result is saved  in ${CYCLE}_out
...
CLEVHGT="${FMAP}/${LEVHGT_CYCLE}"       # levee height [m]
...
CVARSOUT="rivout,rivsto,rivdph,fldsto,flddph,fldfrc,sfcelv,outflw,storge,pthflw,pthout,levsto,levdph" # list output variable (comma separated)
