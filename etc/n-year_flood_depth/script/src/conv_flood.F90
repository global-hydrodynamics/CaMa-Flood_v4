...
! CaMa-Flood simulation domain
      ...
      mx=int( (east -west )/csize +0.001 )
      my=int( (north-south)/csize +0.001 )

      print *, 'dph domain', west, east, south, north, mx, my
...
! ===============================================
      ...
      !fflood='./Mekong-e2o/downscaled_flddph/N09E102_RP50_3sec.bin'
      fflood='./flood.bin'
      ...
      print *, "dph size from fortran:", mx2, my2, size(out)
