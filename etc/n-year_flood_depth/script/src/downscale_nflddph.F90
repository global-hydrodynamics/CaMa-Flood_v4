...
! CaMa-Flood parameters       
      character*128             ::  param                         !! river map parameters
      integer                  ::  iXX, iYY
...
!
      ...
      integer*1,allocatable    ::  floodm(:,:)                   !! downscaled flood mask
!
      character*128             ::  outdir, mapdir, hires
      character*128            ::  fnextxy, fflood, ffloodm, rfile
...
! downscale target domain
      ...
      call getarg(7,fflood)     !! downscaled file
      call getarg(8,ffloodm)     !! downscaled mask file
      call getarg(9,outdir)     !! downscaled mask file
...
! calculate number of cell size
      ...
      print *, 'downscale domain:', west2, east2, south2, north2, mx, my
...
! open hires files
 ...
 1090   continue
      ...
      print *, ffloodm
      open(11, file=ffloodm, form='unformatted', access='direct', recl=1*mx*my)
      write(11,rec=1) floodm
      close(11)
