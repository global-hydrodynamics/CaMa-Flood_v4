...
#PBS -q F200
#PBS -l select=4:ncpus=40:mpiprocs=4:mem=150gb
#PBS -j oe
#PBS -m ea
#PBS -V
...
# BASE=`pwd`/..
BASE="/home/yamadai/cluster/cmf_v404_mpi"  # setting for PBS in cluster
...
CVARSOUT="outflw,storge,fldfrc,rivdph" # list output variable (comma separated)
