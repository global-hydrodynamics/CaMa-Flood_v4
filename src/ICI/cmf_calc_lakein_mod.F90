...
DO ISEQ=1, NSEQALL
  DRIVRIN = D2RIVSTO(ISEQ,1) * D2LAKEFRC(ISEQ,1) / (RINDMP * 8.64D4) * DT !! m3
  DFLDRIN = D2FLDSTO(ISEQ,1) * D2LAKEFRC(ISEQ,1) / (RINDMP * 8.64D4) * DT !! m3
  D2RIVSTO(ISEQ,1) = D2RIVSTO(ISEQ,1) - DRIVRIN
  D2FLDSTO(ISEQ,1) = D2FLDSTO(ISEQ,1) - DFLDRIN
