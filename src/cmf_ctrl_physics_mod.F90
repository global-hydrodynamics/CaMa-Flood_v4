...
USE YOS_CMF_PROG,          ONLY: P2RIVSTO, P2FLDSTO, D2FLDOUT, D2FLDOUT_PRE, P2LEVSTO
USE YOS_CMF_DIAG,          ONLY: D2STORGE
!
USE CMF_CALC_OUTFLW_MOD,   ONLY: CMF_CALC_OUTFLW, CMF_CALC_INFLOW, CMF_CALC_INFLOW_LSMAPAT
