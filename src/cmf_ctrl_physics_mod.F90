...
USE YOS_CMF_PROG,          ONLY: B2FLDOUT, B2FLDOUT_PRE
!
...
!=== 1. Calculate river discharge 
  ...
  IF( .not. LFLDOUT )THEN
    B2FLDOUT(:,:)=0._JPRB    !! OPTION: no high-water channel flow
...
USE YOS_CMF_PROG,            ONLY: B2RIVOUT,     B2FLDOUT,     D2FLDSTO
USE YOS_CMF_PROG,            ONLY: B2RIVOUT_PRE, B2FLDOUT_PRE, B2FLDSTO_PRE, B2RIVDPH_PRE
USE YOS_CMF_DIAG,            ONLY: B2RIVDPH
IMPLICIT NONE
INTEGER(KIND=JPIM),SAVE         :: ISEQ
! ================================================
...
DO ISEQ=1, NSEQALL ! for river mouth
  ...
  B2FLDOUT_PRE(ISEQ,1)=B2FLDOUT(ISEQ,1)                              !! save outflow (t)
