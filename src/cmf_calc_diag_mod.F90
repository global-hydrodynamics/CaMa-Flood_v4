...
USE YOS_CMF_PROG,       ONLY: B2RIVOUT,     B2FLBOUT,     B1PTHFLW,     B2GDWRTN, &
                            & B2RUNOFF,     B2ROFSUB,     B2DAMINF
USE YOS_CMF_DIAG,       ONLY: B2OUTFLW,     B2RIVVEL,     B2PTHOUT,     B2PTHINF, &
                            & B2RIVDPH,     B2STORGE,     B2WEVAPEX,    NADD, &
                            & B2RIVOUT_AVG, B2FLBOUT_AVG, B1PTHFLW_AVG, B2GDWRTN_AVG, B2RUNOFF_AVG, B2ROFSUB_AVG, &
...
DO ISEQ=1, NSEQALL
  ...
  B2FLBOUT_AVG(ISEQ,1)=B2FLBOUT_AVG(ISEQ,1)+B2FLBOUT(ISEQ,1)*DT
