...
D2RIVOUT_aAVG(:,:) = D2RIVOUT_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2FLDOUT_aAVG(:,:) = D2FLDOUT_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2OUTFLW_aAVG(:,:) = D2OUTFLW_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2RIVVEL_aAVG(:,:) = D2RIVVEL_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2PTHOUT_aAVG(:,:) = D2PTHOUT_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2GDWRTN_aAVG(:,:) = D2GDWRTN_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2RUNOFF_aAVG(:,:) = D2RUNOFF_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
D2ROFSUB_aAVG(:,:) = D2ROFSUB_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)

IF ( LDAMOUT ) THEN
  D2DAMINF_aAVG(:,:)  = D2DAMINF_aAVG(:,:)  / REAL(NADD_adp,KIND=JPRB)
ENDIF
IF ( LWEVAP ) THEN
  D2WEVAPEX_aAVG(:,:) = D2WEVAPEX_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
ENDIF

D1PTHFLW_aAVG(:,:) = D1PTHFLW_aAVG(:,:) / REAL(NADD_adp,KIND=JPRB)
DO ILEV=1, NPTHLEV
...
D2RIVOUT_oAVG(:,:) = D2RIVOUT_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2FLDOUT_oAVG(:,:) = D2FLDOUT_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2OUTFLW_oAVG(:,:) = D2OUTFLW_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2RIVVEL_oAVG(:,:) = D2RIVVEL_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2PTHOUT_oAVG(:,:) = D2PTHOUT_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2GDWRTN_oAVG(:,:) = D2GDWRTN_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2RUNOFF_oAVG(:,:) = D2RUNOFF_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
D2ROFSUB_oAVG(:,:) = D2ROFSUB_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)

IF ( LDAMOUT ) THEN
  D2DAMINF_oAVG(:,:)  = D2DAMINF_oAVG(:,:)  / REAL(NADD_out,KIND=JPRB)
ENDIF
IF ( LWEVAP ) THEN
  D2WEVAPEX_oAVG(:,:) = D2WEVAPEX_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
ENDIF

D1PTHFLW_oAVG(:,:) = D1PTHFLW_oAVG(:,:) / REAL(NADD_out,KIND=JPRB)
