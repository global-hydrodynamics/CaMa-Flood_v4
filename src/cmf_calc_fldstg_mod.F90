...
!$OMP PARALLEL DO REDUCTION(+:DGLBSTOPRE2,DGLBSTONEW2,DGLBRIVSTO,DGLBFLDSTO,DGLBFLBARE)
DO ISEQ=1, NSEQALL
!
...
!$OMP PARALLEL DO REDUCTION(+:DGLBSTONEW2,DGLBRIVSTO,DGLBFLDSTO,DGLBFLBARE)
DO ISEQ=1, NSEQALL
  B2SFCELV(ISEQ,1) = B2RIVELV(ISEQ,1) + B2RIVDPH(ISEQ,1)
  DGLBSTONEW2      = DGLBSTONEW2+ D2RIVSTO(ISEQ,1) + D2FLDSTO(ISEQ,1)
  DGLBRIVSTO       = DGLBRIVSTO + D2RIVSTO(ISEQ,1)
