...
IMPLICIT NONE
!* input/output
REAL(KIND=JPRB),INTENT(IN)      :: D2VEC(NSEQALL,1)
...
IMPLICIT NONE
!* input/output
REAL(KIND=JPRD),INTENT(IN)      :: P2VEC(NSEQALL,1)
...
REAL(KIND=JPRB),INTENT(OUT)     :: D2VAR(NSEQALL,1)
!* local variable
INTEGER(KIND=JPIM),SAVE         :: IX,IY, ISEQ
!$OMP THREADPRIVATE               (IX,IY)
!================================================
...
REAL(KIND=JPRD),INTENT(OUT)     :: P2VAR(NSEQALL,1)
!* local variable
INTEGER(KIND=JPIM),SAVE         :: IX,IY, ISEQ
!$OMP THREADPRIVATE               (IX,IY)
!================================================
...
INTEGER(KIND=JPIM),INTENT(OUT)  :: I2VAR(NSEQALL,1)
!* local variable
INTEGER(KIND=JPIM),SAVE         :: IX,IY,ISEQ
!$OMP THREADPRIVATE               (IX,IY)
!================================================
