...
USE YOS_CMF_MAP,        ONLY: NSEQMAX, B2SEALEV
...
USE YOS_CMF_MAP,             ONLY: B2DWNELV, B2ELEVTN, B2SEALEV, B2MEANSL
IMPLICIT NONE
!* local variable
