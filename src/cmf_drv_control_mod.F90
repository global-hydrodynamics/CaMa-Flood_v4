...
USE YOS_CMF_INPUT,           ONLY: LDAMOUT, LLEVEE, LOUTPUT, LTRACE,   LUPSINF
...
USE CMF_CTRL_UPSINF_MOD,     ONLY: CMF_UPSINF_NMLIST
...
! -- Called from CMF_DRV_INIT
USE YOS_CMF_INPUT,           ONLY: LRESTART, LSTOONLY, LOUTPUT, LSEALEV, LDAMOUT, LLEVEE, LTRACE, &
                                   LOUTINI, LUPSINF
! init routines
...
USE CMF_CTRL_UPSINF_MOD,     ONLY: CMF_UPSINF_INIT
...
!*** 3c. Initialize upstream inflow scheme
IF( LUPSINF )THEN
  CALL CMF_UPSINF_INIT
ENDIF
...
! Finalize CaMa-Flood
USE YOS_CMF_INPUT,           ONLY: LOUTPUT, LSEALEV, LTRACE, LUPSINF
...
USE CMF_CTRL_UPSINF_MOD,     ONLY: CMF_UPSINF_END
