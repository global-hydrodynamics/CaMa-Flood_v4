...
##*****************************************
### all Mekong simulation
LINFLOW=".FALSE."                               # true to use Stung Toreng inflow
CINFLOW="${BASE}/inflow/ST_inflow_2000.txt"    # ST inflow file
MAPTAG="_noedge"
EXP="mekong"                       # experiment name (output directory name)

## ST inflow, tonle sap domain
#LINFLOW=".TRUE."                               # true to use Stung Toreng inflow
#CINFLOW="${BASE}/inflow/ST_inflow_2000.txt"    # ST inflow file
#MAPTAG="_tonle"
#EXP="tonle_ST_inf"                       # experiment name (output directory name)

### no ST inflow, tonle sap domain
#LINFLOW=".FALSE."                               # true to use Stung Toreng inflow
#CINFLOW="${BASE}/inflow/ST_inflow_2000.txt"    # ST inflow file
#MAPTAG="_tonle"
#EXP="tonle_no_inf"                       # experiment name (output directory name)
#
##*****************************************
...
FMAP="${BASE}/map/tonle_06min"                # map directory
...
CNEXTXY="${FMAP}/nextxy${MAPTAG}.bin"                # downstream xy (river network map)
